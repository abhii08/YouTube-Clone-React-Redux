...
const Navbar = () => {
  return (
    <div className='flex justify-between px-14 h-14 items-cente bg-[#212121] opacity-95 sticky'>
        <div className='flex gap-8 items-center text-2xl'>
            ...
            <div className='flex items-center justify-center gap-5'>
              ...
              <div className='flex gap-8 items-center text-xl'>
                ...
                <img src='https://avatars.githubusercontent.com/u/27469270?v=4' alt='profile logo' className='w-9 h-9 rounded-full'/>
